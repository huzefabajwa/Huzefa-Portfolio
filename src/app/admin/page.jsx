...
export default function AdminPage() {
  ...
  const tabContent = {
    ...
    services: <AdminServicesView formData={servicesForm} setFormData={setServicesForm} handleSaveData={handleSaveData} data={allData?.services} setAllData={setAllData} setUpdate={setUpdate} />,
    experience: <AdminExperienceView formData={experienceForm} setFormData={setExperienceForm} handleSaveData={handleSaveData} data={allData?.experience} setAllData={setAllData} setUpdate={setUpdate} />,
    education: <AdminEducationView formData={educationForm} setFormData={setEducationForm} handleSaveData={handleSaveData} data={allData?.education} setAllData={setAllData} setUpdate={setUpdate} />,
