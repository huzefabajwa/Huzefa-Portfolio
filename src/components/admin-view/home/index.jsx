...
export default function AdminHomeView({ formData, setFormData, handleSaveData }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Hero Content */}
      <AdminCard title="Hero Section" subtitle="Main headline, role title, and specializations shown in the hero">
        ...
        <div className="mt-4">
          <AdminInput label="Role Title / Subtitle" name="roleTitle" value={formData.roleTitle} onChange={update}
            placeholder="CRM Consultant & Digital Transformation Expert"
            hint="Appears under your name in the hero section" />
        </div>
      </AdminCard>
